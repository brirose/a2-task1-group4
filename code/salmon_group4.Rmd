...
salmon_season %>% 
  ...
  scale_color_gradientn(colours = topo.colors(10)) + # change color palette
  ...
  theme_minimal()
#Are we supposed to add a figure caption?: "This plot shows the monthly averaged seasonal salmon counts for each of the salmon species observed at Willamette Falls Fish. Colored lines represent the different years of observation between 2001 - 2010."
...
salmon_season %>% 
  ...
  labs(title = "Mean Montly Seasonal Salmon Counts at Willamette Falls Fish \n Passage",
       ...
       subtitle = "2001 - 2010",
       caption = "Jaleise Hall, 2021\nSource: Columbia River DART") +
  scale_x_yearmonth(date_labels = "20%y",
...
#Figure caption?: "The plot takes the monthly averaged seasonal salmon counts and separates them by month to see any individual trends occuring for a single month by the corresponding species."
