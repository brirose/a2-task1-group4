...
Issues I'm having: 
* I think the "year" variable I'm using is not a date type? Bri's code for formatting the x-axis breaks isn't working for me.
...
labels <- c("Coho", "Jack Coho", "Steelhead") # capitalize
...
ggplot(data = annual, aes(x = yr, y = annual_count, fill = species)) + # make ggplot
  ...
  #(date_breaks = "1 year", # show all years #date_labels = "%Y") +
  theme_minimal() + # use theme_minimal
