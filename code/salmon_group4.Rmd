...
```{r seasonplot 1, Jaleise Hall, fig.cap= "**Figure 2.** This plot shows the monthly averaged seasonal salmon counts for each of the salmon species observed at Willamette Falls Fish. Colored lines represent the different years of observation between 2001 - 2010."}
...
```{r seasonplot 2, Jaleise Hall, fig.cap= "**Figure 3.** The plot takes the monthly averaged seasonal salmon counts and separates them by month to see any individual trends occuring for a single month by the corresponding species."}
salmon_season %>% 
